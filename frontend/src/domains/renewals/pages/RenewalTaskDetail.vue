...
import SaaSMetricCard from '@/platform/ui/shell/SaaSMetricCard.vue';
import ActionButton from '@/platform/ui/shell/ActionButton.vue';
import StandardCustomerCard from '@/platform/ui/shell/StandardCustomerCard.vue';
