...
vi.mock("../../../composables/usePolicyEndorsementQuickRuntime", () => ({
  usePolicyEndorsementQuickRuntime: ({ policyName: _pn, t: _t, onCreated: _oc, onSuccess: _os }) => ({
    form: { endorsement_type: "Other", endorsement_date: "", net_premium: "", tax_amount: "", commission_amount: "", gross_premium: "", notes: "" },
    fieldErrors: {},
    error: ref(""),
    loading: ref(false),
    typeOptions: [{ label: "Premium Update", value: "Premium Update" }],
    showFinancialFields: ref(false),
    editMode: ref(false),
    dialogTitle: ref(""),
    t: (key) => key,
    resetForm: vi.fn(),
    loadForEdit: vi.fn(),
    submitEndorsement: vi.fn(async () => true),
  }),
}));
