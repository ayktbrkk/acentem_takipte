export const DASHBOARD_TRANSLATIONS = {
  tr: {
    ...
    customerLabel: "Müşteri / Ad Soyad",
    leadSubmitSelectCustomer: "Bir müşteri seçin veya yeni müşteri ekleyin.",
    leadSubmitCompleteCustomer: "Müşteri bölümünü tamamlayın.",
    ...
    recentFollowUpSlaTitle: "Son Öncelikli Takipler",
    recentRenewalAlertTitle: "Son Yenileme Uyarıları",
    recentTodayTasksTitle: "Son Bugünkü Görevler",
    recentOpenClaimsTitle: "Son Açık Hasarlar",
    ...
    email: "E-posta",
    estPremiumInput: "Tahmini Brüt Prim",
    note: "Not",
    cancel: "İptal",
    save: "Kaydet",
    draft: "Taslak",
    ...
    kpiOpenLeads: "Açık Fırsatlar",
    kpiPendingOffers: "Bekleyen Teklifler",
    kpiOfferConversionRate: "Teklif Dönüşüm Oranı",
    kpiCollectionPaidCount: "Ödenen Tahsilat",
    kpiCollectionOpenDifference: "Açık Mutabakat Farkı",
    kpiRenewalDueSoon: "Yaklaşan Yenilemeler",
    ...
    dashboardBadgeActivity: "Aktivite",
    dashboardBadgeCallNote: "Arama Notu",
    dashboardBadgeClaim: "Hasar",
    dashboardBadgeCollection: "Tahsilat",
    dashboardBadgeLead: "Fırsat",
    dashboardBadgeOffer: "Teklif",
    dashboardBadgePayment: "Ödeme",
    dashboardBadgePayout: "Ödeme",
    dashboardBadgePolicy: "Poliçe",
    dashboardBadgeReconciliation: "Mutabakat",
    dashboardBadgeRecord: "Kayıt",
    dashboardBadgeReminder: "Hatırlatıcı",
    dashboardBadgeRenewal: "Yenileme",
    dashboardBadgeRisk: "Risk",
    dashboardBadgeTask: "Görev",
    ...
    recentPrefix: "Son",
    totalLabel: "Toplam",
    previewEmptyTitle: "Bu önizlemede kayıt yok",
    previewEmptyBody: "Önizleme listesi boş; toplam kaydı görüntülemek için Tümünü Gör kullanın.",
    recentOfferPipelineTitle: "Son Bekleyen Teklifler",
    recentConvertedOffersTitle: "Son Dönüşen Teklifler",
    recentLeadsTitle: "Son Fırsatlar",
    recentSalesActionsTitle: "Son Satış Aksiyonları",
    recentCollectionsRiskTitle: "Son Tahsilat Riskleri",
    recentReconciliationPreviewTitle: "Son Mutabakat Kayıtları",
    recentOfferWaitingRenewalsTitle: "Son Teklif Bekleyen Yenilemeler",
    recentRenewalQueueTitle: "Son Yenileme Görevleri",
    recentLinkedPoliciesTitle: "Son Bağlantılı Poliçeler",
  ...
  en: {
    ...
    customerLabel: "Customer / Full Name",
    leadSubmitSelectCustomer: "Select a customer or add a new customer.",
    leadSubmitCompleteCustomer: "Complete the customer section.",
    ...
    recentFollowUpSlaTitle: "Recent Priority Follow-ups",
    recentRenewalAlertTitle: "Recent Renewal Alerts",
    recentTodayTasksTitle: "Recent Today's Tasks",
    recentOpenClaimsTitle: "Recent Open Claims",
    ...
    kpiOfferConversionRate: "Offer Conversion Rate",
    kpiCollectionPaidCount: "Paid Collections",
    kpiCollectionOpenDifference: "Open Reconciliation Difference",
    kpiRenewalDueSoon: "Upcoming Renewals",
    ...
    reconciliationMismatchAmount: "Amount",
    reconciliationMismatchStatus: "Status",
    reconciliationSourceClaim: "Claim",
    reconciliationSourceCustomer: "Customer",
    reconciliationSourcePolicy: "Policy",
    ...
    dashboardBadgeActivity: "Activity",
    dashboardBadgeCallNote: "Call Note",
    dashboardBadgeClaim: "Claim",
    dashboardBadgeCollection: "Collection",
    dashboardBadgeLead: "Lead",
    dashboardBadgeOffer: "Offer",
    dashboardBadgePayment: "Payment",
    dashboardBadgePayout: "Payout",
    dashboardBadgePolicy: "Policy",
    dashboardBadgeReconciliation: "Reconciliation",
    dashboardBadgeRecord: "Record",
    dashboardBadgeReminder: "Reminder",
    dashboardBadgeRenewal: "Renewal",
    dashboardBadgeRisk: "Risk",
    dashboardBadgeTask: "Task",
    ...
    recentPrefix: "Recent",
    totalLabel: "Total",
    previewEmptyTitle: "No records in this preview",
    previewEmptyBody: "The preview list is empty; use View All to browse the total records.",
    recentOfferPipelineTitle: "Recent Pending Offers",
    recentConvertedOffersTitle: "Recent Converted Offers",
    recentLeadsTitle: "Recent Leads",
    recentSalesActionsTitle: "Recent Sales Actions",
    recentCollectionsRiskTitle: "Recent Collection Risks",
    recentReconciliationPreviewTitle: "Recent Reconciliation Records",
    recentOfferWaitingRenewalsTitle: "Recent Renewals Awaiting Offer",
    recentRenewalQueueTitle: "Recent Renewal Tasks",
    recentLinkedPoliciesTitle: "Recent Linked Policies",
