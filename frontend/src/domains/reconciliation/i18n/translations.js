export const RECONCILIATION_TRANSLATIONS = {
  tr: {
    ...
    retry: "Tekrar Dene",
    fetchLimitWarning: "Gösterilen kayıt sayısı limite ulaştı. Daha fazlası için filtreyi daraltın veya dışa aktarın.",
    bulkResultSummary: "Toplu işlem tamamlandı",
    bulkResultProcessed: "işlendi",
    bulkResultSkipped: "atlandı",
    bulkResultFailed: "başarısız",
    bulkResultEmpty: "işlem yapılmadı",
    selectedRows: "satır seçildi",
    selectAllRows: "Görünen satırların tümünü seç",
    clearSelection: "Seçimi temizle",
    selectRowsFirst: "Önce satır seçin",
    colCompany: "Şirket",
    colPeriod: "Dönem",
    colTotalPolicy: "Poliçe",
    colTotalPremium: "Toplam Prim",
    colCompanyStatement: "Şirket Ekstresi",
    colDifference: "Fark",
    colActions: "İşlemler",
    ...
    importDialogEyebrow: "Ekstre Önizlemesi",
    ...
    delimiter: "Ayıraç",
    limitLabel: "Kayıt limiti",
    buildPreview: "Önizleme Oluştur",
    cancel: "İptal",
    actionDialogEyebrow: "Mutabakat İşlemi",
    importMatchStatusMatched: "Eşleşti",
    importMatchStatusUnmatched: "Eşleşmedi",
    previewStatus_overdue: "Gecikmiş",
    previewStatus_open: "Açık",
    previewStatus_pending: "Beklemede",
    previewStatus_paid: "Ödendi",
    previewStatus_accrued: "Tahakkuk",
    policy: "Poliçe",
    payment: "Ödeme",
    sync: "Sync Çalıştır",
    syncing: "Sync...",
    ...
    commissionAgingSummary: "Komisyon Yaşlandırma",
    agingCurrent: "Vadesi Gelmemiş",
    agingCurrentLabel: "Güncel",
    previewTruncated: "Önizleme kayıt limitine ulaşıldı; özet yaklaşık değerler içerebilir.",
    aging1to30: "1-30 Gün",
    aging1to30Label: "1-30 Gün",
    aging31to60: "31-60 Gün",
    aging31to60Label: "31-60 Gün",
    aging61to90: "61-90 Gün",
    aging61to90Label: "61-90 Gün",
    aging90plus: "90+ Gün",
    aging90plusLabel: "90+ Gün",
  },
  en: {
    ...
    retry: "Retry",
    fetchLimitWarning: "Showing the maximum loaded records. Narrow filters or export for more.",
    bulkResultSummary: "Bulk action completed",
    bulkResultProcessed: "processed",
    bulkResultSkipped: "skipped",
    bulkResultFailed: "failed",
    bulkResultEmpty: "nothing processed",
    ...
    colCompany: "Company",
    colPeriod: "Period",
    colTotalPolicy: "Policies",
    colTotalPremium: "Total Premium",
    colCompanyStatement: "Company Statement",
    ...
    importDialogEyebrow: "Statement Preview",
    ...
    delimiter: "Delimiter",
    limitLabel: "Record limit",
    buildPreview: "Build Preview",
    cancel: "Cancel",
    actionDialogEyebrow: "Reconciliation Action",
    importMatchStatusMatched: "Matched",
    importMatchStatusUnmatched: "Unmatched",
    previewStatus_overdue: "Overdue",
    previewStatus_open: "Open",
    previewStatus_pending: "Pending",
    previewStatus_paid: "Paid",
    previewStatus_accrued: "Accrued",
    policy: "Policy",
    payment: "Payment",
    sync: "Run Sync",
    syncing: "Syncing...",
    ...
    commissionAgingSummary: "Commission Aging",
    agingCurrent: "Not Yet Due",
    agingCurrentLabel: "Current",
    previewTruncated: "Preview reached the record limit; summary may be approximate.",
    aging1to30: "1-30 Days",
    aging1to30Label: "1-30 Days",
    aging31to60: "31-60 Days",
    aging31to60Label: "31-60 Days",
    aging61to90: "61-90 Days",
    aging61to90Label: "61-90 Days",
    aging90plus: "90+ Days",
    aging90plusLabel: "90+ Days",
  }
};
