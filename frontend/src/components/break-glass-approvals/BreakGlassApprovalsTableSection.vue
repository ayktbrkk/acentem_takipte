          ...
          <tr v-for="row in pendingRows" :key="row.name" class="at-table-row align-top">
            ...
            <td class="at-table-cell min-w-[220px]">
              <label class="mb-2 flex flex-col gap-1">
                <span class="text-[11px] font-bold uppercase tracking-wider text-slate-400">{{ t("durationHours") }}</span>
              ...
              <label class="mb-2 flex flex-col gap-1">
                <span class="text-[11px] font-bold uppercase tracking-wider text-slate-400">{{ t("comments") }}</span>
                <input
