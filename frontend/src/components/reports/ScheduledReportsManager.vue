...
const copy = {
  tr: {
    ...
    subtitle: "Site konfigrasyonu ile tanimli rapor teslimleri",
    run: "Zamanlanmis Raporlari Calistir",
    new: "Yeni Kural",
    loading: "Raporlar yukleniyor...",
    empty: "Tanimli zamanlanmis rapor yok.",
    recipients: "Alicilar",
    filters: "Filtreler",
    frequency: "Frekans",
    format: "Format",
    limit: "Limit",
    deliveryChannel: "Teslim Kanali",
    deliveryEmail: "Dogrudan E-posta",
    deliveryOutbox: "Notification Outbox",
    lastRun: "Son Calisma",
    lastStatus: "Son Durum",
    statusSent: "Gonderildi",
    statusQueued: "Kuyruga Alindi",
    statusInvalid: "Gecersiz",
    statusSkipped: "Atlandi",
    statusUnknown: "Bilinmiyor",
    enabled: "Etkin",
    disabled: "Pasif",
    edit: "Duzenle",
    remove: "Sil",
    createTitle: "Yeni Zamanlanmis Rapor",
    editTitle: "Zamanlanmis Raporu Duzenle",
    cancel: "Iptal",
    save: "Kaydet",
    reportKey: "Rapor",
    weekday: "Haftanin Gunu",
    dayOfMonth: "Ayin Gunu",
    officeBranch: "Ofis Sube",
    insuranceBranch: "Sigorta Bransi",
    ...
    recipientsError: "En az bir alici girilmelidir.",
    recipientsInvalid: "Gecersiz alici adresi: {{value}}",
    frequencyError: "Geçerli frekans secilmelidir.",
    weekdayError: "Haftalik rapor icin 0-6 arasinda hafta gunu (0=Pazar,6=Cumartesi) giriniz.",
    dayOfMonthError: "Aylik rapor icin 1-31 arasi ay gunu giriniz.",
    limitError: "Limit en az 1 olmalidir.",
    reportKeyError: "Rapor secilmelidir.",
    formatError: "Geçerli format seçilmelidir.",
    deliveryChannelError: "Teslim kanali gecersiz.",
    filterPrefix: "Filtre: ",
    removeConfirm: "Bu zamanlanmis rapor kaydini silmek istediginize emin misiniz?",
  },
  en: {
