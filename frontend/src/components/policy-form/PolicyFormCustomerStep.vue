...
defineProps({
  ...
  customerLockedMessage: { type: Object, required: true },
  customerPickerLabel: { type: Object, required: true },
  customerSearchPlaceholder: { type: Object, required: true },
  customerNoResultsText: { type: Object, required: true },
