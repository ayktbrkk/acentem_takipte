...
const copy = {
  tr: {
    ...
    columnOpen: "Açık",
    columnOpenHint: "Henüz ilk değerlendirme aşamasındaki yenilemeler",
    columnInProgress: "Devam Ediyor",
    columnInProgressHint: "Müşteri iletişimi ve teklif takibi süren kartlar",
    columnCancelled: "İptal",
    columnCancelledHint: "Süreç dışına alınan yenileme kartları",
  ...
  en: {
    ...
    columnOpen: "Open",
    columnOpenHint: "Renewals still in initial assessment",
    columnInProgress: "In Progress",
    columnInProgressHint: "Cards with active customer follow-up",
    columnCancelled: "Cancelled",
    columnCancelledHint: "Renewals removed from active flow",
