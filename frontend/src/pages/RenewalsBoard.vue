...
const copy = {
  tr: {
    title: "Yenilemeler",
    subtitle: "Bitişe yakin policeler ve takip görevleri",
    refresh: "Yenile",
    exportXlsx: "Excel",
    exportPdf: "PDF",
    newTask: "Yeni Görev",
    ...
    loadError: "Yenileme görevleri yuklenirken bir hata oluştu.",
    emptyTitle: "Yenileme Kaydi Yok",
    emptyDescription: "Gosterilecek yenileme görevi bulunamadı.",
    ...
    searchPlaceholder: "Görev / police ara",
