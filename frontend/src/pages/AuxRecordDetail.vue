...
const copy = {
  tr: {
    ...
    noRelatedRecords: "İlişkili kayit bulunamadı.",
    activityTitle: "Aktivite",
    noActivity: "Aktivite kaydi bulunamadı.",
    ...
    noSignals: "Kayıtli sinyal bulunamadı.",
    assignmentContext: "Atama Baglami",
    assignmentLifecycle: "Atama Yasam Döngüsü",
