...
const copy = {
  tr: {
    ...
    noRelatedPolicies: "İlgili police bulunamadı.",
    ...
    conversionHint: "Durum güncelleme ve policeye cevirme islemleri teklif panosundan veya yonetim ekranindan yapilabilir.",
    ...
    conversionConverted: "Poliçeye Donustu",
    conversionPending: "Henuz Donusmedi",
    sourceLead: "Kaynak Lead",
    createdAt: "Oluşturuldu",
    modifiedAt: "Güncellendi",
    timelineCreated: "Teklif kaydi oluşturuldu",
    timelineUpdated: "Teklif kaydi güncellendi",
