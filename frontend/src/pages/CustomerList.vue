...
const copy = {
  tr: {
    ...
    activePoliciesCount: "Aktif Poliçe Sayısı",
    activeRenewalsCount: "Aktif Yenileme Sayısı",
  ...
  en: {
    ...
    activePoliciesCount: "Active Policy Count",
    activeRenewalsCount: "Active Renewal Count",
...
const customerListColumns = computed(() => [
  ...
  { key: "full_name", label: t("customerFullName"), width: "220px" },
  ...
  { key: "active_policy_count", label: t("activePoliciesCount"), width: "130px", type: "amount", align: "right" },
  { key: "active_renewal_count", label: t("activeRenewalsCount"), width: "140px", type: "amount", align: "right" },
