...
const copy = {
  tr: {
    ...
    presetHighPortfolio: "Yüksek Portfoy",
    presetPortfolioAndOpenOffer: "Portfoy + Açık Teklif",
    ...
    loadError: "Müşteri listesi yuklenirken hata oluştu. Lütfen tekrar deneyin.",
    emptyTitle: "Müşteri Bulunamadi",
    emptyDescription: "Filtrelere uygun musteri kaydi bulunamadı.",
    showing: "Gosterilen",
    page: "Sayfa",
    previous: "Onceki",
    next: "Sonraki",
...
const quickCreateCommon = computed(() => ({
  ...
  failed: activeLocale.value === "tr" ? "Hızlı musteri oluşturma başarısız oldu." : "Quick customer create failed.",
}));
