...
const copy = {
  tr: {
    ...
    heroSubtitleDaily: "Operasyon öncelikleri, bekleyen isler ve kritik kuyruklar icin canli operasyon görünümü.",
    ...
    heroSubtitleRenewals: "Yaklaşan bitisler ve yenileme görevlerini önceliklendirin.",
    tabDaily: "Operasyon",
    tabSales: "Satış",
    ...
    noLead: "Fırsat kaydi bulunamadı.",
    ...
    actionOfferQueueHint: "Gönderildi / kabul edildi ve policeye donusmesi beklenen teklifler",
    ...
    trendAgainstPrevious: "önceki doneme gore",
    trendAgainstPreviousPeriod: "önceki ayni sureye gore",
    ...
    quickPayment: "Ödeme Operasyonlari",
    quickPaymentDesc: "Tahsilat ve payout hareketlerini takip et",
    quickRenewal: "Yenileme Panosu",
    quickRenewalDesc: "Bitişe 30 gun kalan policeleri denetle",
    ...
    noPaymentPreview: "Tahsilat veya odeme kaydi bulunamadı.",
    reconciliationPreview: "Açık Mutabakat Farklari",
    noReconciliationPreview: "Açık mutabakat kaydi bulunamadı.",
    ...
    noRenewalStatus: "Durum ozeti oluşturulacak yenileme kaydi yok.",
    ...
    noTopCompanies: "Sirket bazli uretim verisi bulunamadı.",
    ...
    myTasksHint: "Atanmis görevleri bugun ve gelecek hafta icin izleyin.",
    ...
    noMyReminders: "Açık hatirlatici bulunmuyor.",
    ...
    grossProduction: "Brüt Uretim",
    recentPolicies: "Son Poliçeler",
    noPolicy: "Poliçe kaydi bulunamadı.",
    issueDate: "Tanzim",
    offerPipeline: "Teklif Sureci",
    readyOffers: "Hazır Teklifler",
    noOffer: "Teklif kaydi bulunamadı.",
