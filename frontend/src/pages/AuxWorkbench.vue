...
const copy = {
  tr: {
    ...
    highValueSnapshots: "Yüksek Deger",
    ...
    snapshotTrendHint: "Görünen kayitlardan son uc snapshot gunu ozetlenir",
    ...
    overdueRemindersHint: "Hatırlatma zamani gecmis acik hatirlaticilar",
    ...
    attachedCustomersHint: "AT Customer kayitlarina bağlı dosyalar",
    attachedPoliciesHint: "AT Policy kayitlarina bağlı dosyalar",
    attachedClaimsHint: "AT Claim kayitlarina bağlı dosyalar",
