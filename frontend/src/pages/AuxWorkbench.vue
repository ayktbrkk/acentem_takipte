...
const copy = {
  tr: {
    ...
    attachedCustomers: "Müşteri Bağlantısı",
    attachedPolicies: "Poliçe Bağlantısı",
    attachedClaims: "Hasar Bağlantısı",
    snapshotTrendTitle: "Snapshot Trendi",
    snapshotTrendHint: "Görünen kayıtlardan son üç snapshot günü özetlenir",
    snapshotWindowHint: "Mevcut filtre penceresindeki kayıtlar",
    highRiskHint: "Claim risk seviyesi High olan kayıtlar",
    highValueHint: "Değer bandı High veya Premium olan kayıtlar",
    averageScoreHint: "Filtreli kayıtlar için ortalama skor",
    auditWindowHint: "Mevcut filtre penceresindeki audit kayıtları",
    reminderWindowHint: "Mevcut filtre penceresindeki hatırlatıcılar",
    openRemindersHint: "Durumu Open olan hatırlatıcılar",
    overdueRemindersHint: "Hatırlatma zamanı geçmiş açık hatırlatıcılar",
    highPriorityRemindersHint: "Önceliği High olan açık hatırlatıcılar",
    createEventsHint: "Oluşturma aksiyonları",
    editEventsHint: "Düzenleme aksiyonları",
    deleteEventsHint: "Silme aksiyonlari",
    runEventsHint: "Çalıştırma aksiyonlari",
    filesWindowHint: "Mevcut filtre penceresindeki dosyalar",
    pdfFilesHint: "PDF tipindeki belgeler",
    imageFilesHint: "Görsel tipindeki belgeler",
    spreadsheetFilesHint: "Tablo ve spreadsheet belgeleri",
    attachedCustomersHint: "AT Customer kayıtlarına bağlı dosyalar",
    attachedPoliciesHint: "AT Policy kayıtlarına bağlı dosyalar",
    attachedClaimsHint: "AT Claim kayıtlarına bağlı dosyalar",
