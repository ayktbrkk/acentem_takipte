...
const copy = {
  tr: {
    ...
    sync: "Sync Çalıştır",
    syncing: "Sync...",
    bulkResolve: "Açıklari Toplu Coz",
    bulkResolving: "Toplu Cozuluyor...",
    bulkIgnore: "Açıklari Toplu Yoksay",
    bulkIgnoring: "Toplu Yoksayiliyor...",
    bulkResolveConfirm: "Görünen acik mutabakat kayitlari cozulmus olarak isaretlensin mi?",
    bulkIgnoreConfirm: "Görünen acik mutabakat kayitlari yoksayilsin mi?",
    ...
    emptyCommissionPreview: "Komisyon tahakkuk kaydi bulunamadı.",
    loading: "Yükleniyor...",
    loadErrorTitle: "Mutabakat Verileri Yüklenemedi",
    loadError: "Mutabakat masasi verileri yuklenirken bir hata oluştu.",
    ...
    empty: "Gosterilecek mutabakat kaydi bulunamadı.",
    source: "Kaynak",
    type: "Uyumsuzluk",
    status: "Durum",
    dueDate: "Vade",
    ...
    actionNoteSubtitle: "Kayıt icin aciklama notu güncelle",
