...
const copy = {
  tr: {
    ...
    quickSegmentSubtitle: "Hedef musteri segmenti oluştur",
    ...
    quickReminderSubtitle: "Müşteri veya kayit icin zaman bazli hatirlatici ekle",
    ...
    referenceContext: "Kayıt Baglami",
    ...
    referenceNameFilter: "Kayıt adi / ID",
    ...
    emptyOutbox: "Gonderim kuyrugu kaydi bulunamadı.",
    emptyOutboxTitle: "Kuyruk Kaydi Yok",
    emptyDrafts: "Taslak kaydi bulunamadı.",
