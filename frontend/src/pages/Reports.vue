...
const copy = {
  tr: {
    ...
    presetLabel: "Rapor Sablonu",
    savePreset: "Kaydet",
    deletePreset: "Sil",
    applyFilters: "Uygula",
    clearFilters: "Temizle",
    branchFilter: "Sigorta bransi",
    companyFilter: "Sigorta sirketi",
    salesEntityFilter: "Satis birimi",
    statusFilter: "Durum",
    loading: "Rapor yukleniyor...",
    loadErrorTitle: "Rapor Yuklenemedi",
    emptyTitle: "Kayit bulunamadi",
    emptyDescription: "Secili filtrelerle rapor verisi bulunamadi.",
    totalRows: "Toplam Satir",
    scopeAll: "Tum subeler",
    scopePrefix: "Ofis Sube",
    exportError: "Rapor disa aktarma basarisiz oldu.",
    exporting: "Disa aktariliyor...",
    summaryRows: "Kayit Sayisi",
    summaryGrossPremium: "Brut Prim",
    summaryCommission: "Komisyon",
    summaryPaidAmount: "Tahsil Edilen",
    summaryActivePolicies: "Aktif Police",
    summaryAvgConversionRate: "Ort. Teklif Donusumu",
    ...
    scheduledSaveError: "Zamanlanmis rapor kaydedilemedi.",
    scheduledDeleteError: "Zamanlanmis rapor silinemedi.",
    scheduledTitle: "Zamanlanmis Raporlar",
    scheduledSubtitle: "Site konfigrasyonu ile tanimli rapor teslimleri",
    runScheduledReports: "Zamanlanmis Raporlari Calistir",
...
const reportCatalog = {
  ...
  claim_loss_ratio: {
    label: { tr: "Hasar/Prim Orani", en: "Claim Loss Ratio" },
  ...
  agent_performance: {
    label: { tr: "Acente Uretim Karnesi", en: "Agency Performance Scorecard" },
  ...
  customer_segmentation: {
    label: { tr: "Musteri Segmentasyonu", en: "Customer Segmentation" },
...
const columnLabels = {
  ...
  policy: { tr: "Police", en: "Policy" },
  office_branch: { tr: "Ofis Sube", en: "Office Branch" },
  branch: { tr: "Sigorta Bransi", en: "Insurance Branch" },
  insurance_company: { tr: "Sigorta Sirketi", en: "Insurance Company" },
  sales_entity: { tr: "Satis Birimi", en: "Sales Entity" },
  assigned_agent: { tr: "Atanan Temsilci", en: "Assigned Agent" },
  status: { tr: "Durum", en: "Status" },
  claim_status: { tr: "Hasar Durumu", en: "Claim Status" },
  assigned_to: { tr: "Atanan Kisi", en: "Assigned To" },
  renewal_date: { tr: "Yenileme Tarihi", en: "Renewal Date" },
  due_date: { tr: "Vade Tarihi", en: "Due Date" },
  gross_premium: { tr: "Brut Prim", en: "Gross Premium" },
  total_gross_premium: { tr: "Toplam Brut Prim", en: "Total Gross Premium" },
  ...
  loss_ratio_percent: { tr: "Hasar/Prim Orani", en: "Loss Ratio" },
  policy_count: { tr: "Police Sayisi", en: "Policy Count" },
  active_policy_count: { tr: "Aktif Police", en: "Active Policies" },
  cancelled_policy_count: { tr: "Iptal Police", en: "Cancelled Policies" },
  offer_count: { tr: "Teklif Sayisi", en: "Offer Count" },
  accepted_offer_count: { tr: "Kabul Edilen Teklif", en: "Accepted Offers" },
  converted_offer_count: { tr: "Policeye Donusen Teklif", en: "Converted Offers" },
  offer_conversion_rate: { tr: "Teklif Donusum Orani", en: "Offer Conversion Rate" },
  renewal_task_count: { tr: "Yenileme Gorevi", en: "Renewal Tasks" },
  completed_renewal_task_count: { tr: "Tamamlanan Yenileme", en: "Completed Renewals" },
  open_renewal_task_count: { tr: "Acik Yenileme Yuku", en: "Open Renewal Load" },
  renewal_success_rate: { tr: "Yenileme Basari Orani", en: "Renewal Success Rate" },
  claim_count: { tr: "Hasar Sayisi", en: "Claim Count" },
  claim_history_segment: { tr: "Hasar Gecmisi", en: "Claim History" },
