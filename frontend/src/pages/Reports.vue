...
const copy = {
  tr: {
    ...
    summaryOpenRenewals: "Açık Yenileme Yuku",
    summaryLoyalCustomers: "Sadik Müşteri",
    summaryClaimCustomers: "Hasarli Müşteri",
    ...
    comparisonSummaryHint: "Seçili aralik önceki esit periyot ile karsilastirilir",
    columns: "Kolonlar",
    ...
    runScheduledReports: "Zamanlanmis Raporlari Çalıştır",
    ...
    runSegmentSnapshots: "Snapshotlari Çalıştır",
...
const columnLabels = {
  ...
  offer_conversion_rate: { tr: "Teklif Donusum Oranı", en: "Offer Conversion Rate" },
  ...
  open_renewal_task_count: { tr: "Açık Yenileme Yuku", en: "Open Renewal Load" },
