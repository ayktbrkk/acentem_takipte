...
const copy = {
  tr: {
    ...
    branchFilter: "Brans (içerir)",
    salesEntityFilter: "Satış birimi (içerir)",
    companyFilter: "Sigorta sirketi (içerir)",
    ...
    loadError: "Firsat listesi yuklenirken hata oluştu. Lütfen tekrar deneyin.",
    emptyTitle: "Firsat Bulunamadi",
    emptyDescription: "Filtrelere uygun firsat kaydi bulunamadı.",
    showing: "Gosterilen",
    page: "Sayfa",
    previous: "Onceki",
    next: "Sonraki",
    ...
    sortConversionPriority: "Donusum Durumu (Öncelik)",
...
const quickCreateCommon = computed(() => ({
  ...
  failed: activeLocale.value === "tr" ? "Hızlı kayit oluşturulamadi." : "Quick create failed.",
}));
