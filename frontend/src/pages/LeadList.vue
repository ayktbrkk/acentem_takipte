...
const copy = {
  tr: {
    title: "Lead Yonetimi",
    subtitle: "Lead workbench: filtre, preset ve donusum takibi",
    refresh: "Yenile",
    searchPlaceholder: "Lead / e-posta / musteri / kayit ara",
    ...
    branchFilter: "Brans (icerir)",
    salesEntityFilter: "Satis birimi (icerir)",
    companyFilter: "Sigorta sirketi (icerir)",
    estimatedMinFilter: "Min Tahmini Brut Prim",
    estimatedMaxFilter: "Max Tahmini Brut Prim",
    hasCustomerOnly: "Sadece musterisi olanlar",
    canConvertOnly: "Sadece teklife cevrilebilir",
    loading: "Yukleniyor...",
    loadErrorTitle: "Liste Yuklenemedi",
    loadError: "Lead listesi yuklenirken hata olustu. Lutfen tekrar deneyin.",
    emptyTitle: "Lead Bulunamadi",
    emptyDescription: "Filtrelere uygun lead kaydi bulunamadi.",
    showing: "Gosterilen",
    page: "Sayfa",
    previous: "Onceki",
    next: "Sonraki",
    ...
    convertLeadError: "Lead teklife donusturulemedi. Eksik alanlari kontrol edin.",
    presetDefault: "Standart",
    presetOpen: "Acik Leadler",
    ...
    presetWaitingLeads: "Bekleyen Leadler",
    ...
    sortEstimatedDesc: "Tahmini Brut (Yuksek)",
    sortEstimatedAsc: "Tahmini Brut (Dusuk)",
    sortStalePriority: "Takip Onceligi",
    sortActionableFirst: "Aksiyon Bekleyen Ilk",
    sortConversionPriority: "Donusum Durumu (Oncelik)",
    conversionStateUnconverted: "Donusmeyenler",
    conversionStateAnyConverted: "Donusenler",
    conversionStateOffer: "Teklife Donusen",
    conversionStatePolicy: "Policeye Donusen",
    staleStateFresh: "Guncel",
    staleStateFollowUp: "Takip Et",
    staleStateStale: "Bekliyor",
    statusDraft: "Taslak",
    statusOpen: "Acik",
    statusReplied: "Gorusuldu",
...
const quickLeadUi = computed(() => ({
  ...
  newLabel: sessionState.locale === "tr" ? "Yeni Lead" : "New Lead",
}));
