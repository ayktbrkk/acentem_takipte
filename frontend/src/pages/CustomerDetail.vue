...
const copy = {
  tr: {
    ...
    insightSignalHighPremium: "Yüksek premium katkisi",
    insightSignalMediumPremium: "Orta premium katkisi",
    insightSignalCleanClaims: "Temiz hasar görünümü",
    insightSignalRenewalPipeline: "Yaklaşan yenileme firsati",
    ...
    insightRiskCancellationHistory: "İptal gecmisi dikkat gerektiriyor",
    activePoliciesTitle: "Aktif Poliçeler",
    noActivePolicy: "Aktif police kaydi bulunamadı.",
    paymentSummaryTitle: "Ödeme Özeti",
    noPaymentHistory: "Ödeme kaydi bulunamadı.",
    paymentDate: "Ödeme Tarihi",
    overdueInstallments: "Geciken Taksit",
    claimsTitle: "Hasarlar",
    noClaims: "Hasar kaydi bulunamadı.",
    ...
    noRelatedCustomer: "İlişkili kisi kaydi bulunamadı.",
    ...
    noReminder: "Hatırlatıcı kaydi yok.",
    ...
    noInsuredAsset: "Sigortalanan varlik bulunamadı.",
    assetType: "Varlık Turu",
    assetIdentifier: "Varlık Kimligi",
    policyBranch: "Brans",
    endDate: "Bitiş",
    ...
    noTimeline: "Zaman tuneli kaydi bulunamadı.",
