...
import App from "./platform/shell/App.vue";
import router from "./platform/router";
import { getAppPinia, setAppPinia } from "./pinia";
import { hydrateSessionState } from "./platform/state/session";
import { useBranchStore } from "./platform/state/branchStore";
import { useAuthStore } from "./platform/state/authStore";
import { resolveRouteDocumentTitle } from "./platform/router/routeMeta";
import "./style.css";
