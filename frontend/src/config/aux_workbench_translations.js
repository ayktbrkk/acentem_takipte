export const AUX_WORKBENCH_TRANSLATIONS = {
  tr: {
    ...
    emptyFilteredTitle: "Filtrelerle eşleşen kayıt yok",
    emptyFilteredDescription: "Seçili şube kapsamı veya filtrelerle eşleşen kayıt bulunamadı. Filtreleri temizleyip tekrar deneyin.",
    showing: "Gösterilen",
  ...
  en: {
    ...
    emptyFilteredTitle: "No records match the current filters",
    emptyFilteredDescription: "No records match the selected branch scope or filters. Clear the filters and try again.",
    showing: "Showing",
