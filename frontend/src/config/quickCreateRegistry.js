...
export const quickCreateRegistry = {
  ...
  renewal_task: {
    ...
    fields: [
      ...
      { name: "lost_reason_code", type: "select", label: i18nLabel("Kayip Sebebi", "Lost Reason"), options: [
        ...
        option("Customer Declined", "Musteri Vazgecti", "Customer Declined"),
  ...
  customer_relation: {
    ...
    title: i18nLabel("Hizli Musteri Iliskisi", "Quick Customer Relation"),
    subtitle: i18nLabel("Musteriler arasi iliski kaydi olustur", "Create a relationship between customers"),
    ...
    fields: [
      { name: "customer", type: "select", label: i18nLabel("Musteri", "Customer"), optionsSource: "customers", required: true },
      { name: "related_customer", type: "select", label: i18nLabel("Iliskili Musteri", "Related Customer"), optionsSource: "customers", required: true },
      { name: "relation_type", type: "select", label: i18nLabel("Iliski Turu", "Relation Type"), options: [
      ...
      { name: "is_household", type: "checkbox", label: i18nLabel("Ayni Hane", "Same Household") },
      { name: "notes", type: "textarea", label: i18nLabel("Not", "Notes"), rows: 3, fullWidth: true },
    ],
  },
  insured_asset: {
    key: "insured_asset",
    title: i18nLabel("Hizli Sigortalanan Varlik", "Quick Insured Asset"),
    subtitle: i18nLabel("Musteriye bagli sigortalanan varlik kaydi olustur", "Create an insured asset linked to a customer"),
    ...
    fields: [
      { name: "customer", type: "select", label: i18nLabel("Musteri", "Customer"), optionsSource: "customers", required: true },
      { name: "policy", type: "select", label: i18nLabel("Police", "Policy"), optionsSource: "policies" },
      { name: "asset_type", type: "select", label: i18nLabel("Varlik Turu", "Asset Type"), options: [
        option("Vehicle", "Arac", "Vehicle"),
        option("Home", "Konut", "Home"),
        option("Health Person", "Saglik Kisi", "Health Person"),
      ...
      { name: "asset_label", type: "text", label: i18nLabel("Varlik Basligi", "Asset Label"), required: true, fullWidth: true },
      { name: "asset_identifier", type: "text", label: i18nLabel("Varlik Kimligi", "Asset Identifier"), fullWidth: true },
      { name: "notes", type: "textarea", label: i18nLabel("Not", "Notes"), rows: 3, fullWidth: true },
    ],
  },
  call_note: {
    key: "call_note",
    title: i18nLabel("Hizli Arama Notu", "Quick Call Note"),
    subtitle: i18nLabel("Musteriyle yapilan arama kaydini olustur", "Create a phone interaction record"),
    ...
    fields: [
      ...
      { name: "channel", type: "select", label: i18nLabel("Kanal", "Channel"), options: [
        ...
        option("Video Call", "Goruntulu Arama", "Video Call"),
        option("Other", "Diger", "Other"),
      ] },
      { name: "direction", type: "select", label: i18nLabel("Yon", "Direction"), options: [
      ...
      { name: "call_status", type: "select", label: i18nLabel("Arama Durumu", "Call Status"), options: [
        ...
        option("Completed", "Tamamlandi", "Completed"),
        option("Missed", "Kacirildi", "Missed"),
        option("No Answer", "Ulasilamadi", "No Answer"),
        option("Cancelled", "Iptal", "Cancelled"),
      ] },
  ...
  segment: {
    key: "segment",
    title: i18nLabel("Hizli Segment", "Quick Segment"),
    subtitle: i18nLabel("Kampanya hedef segmenti olustur", "Create a campaign target segment"),
  ...
  campaign: {
    key: "campaign",
    title: i18nLabel("Hizli Kampanya", "Quick Campaign"),
    subtitle: i18nLabel("Segmente bagli kampanya olustur", "Create a segment-based campaign"),
    ...
    fields: [
      ...
      { name: "template", type: "select", label: i18nLabel("Sablon", "Template"), optionsSource: "notificationTemplates" },
      { name: "channel", type: "select", label: i18nLabel("Kanal", "Channel"), options: [
        option("WHATSAPP", "WhatsApp", "WhatsApp"),
        option("SMS", "SMS", "SMS"),
        option("Email", "E-posta", "Email"),
      ...
      { name: "status", type: "select", label: i18nLabel("Durum", "Status"), options: [
        option("Draft", "Taslak", "Draft"),
        option("Planned", "Planlandi", "Planned"),
        option("Running", "Calisiyor", "Running"),
        option("Completed", "Tamamlandi", "Completed"),
        option("Cancelled", "Iptal", "Cancelled"),
      ] },
  ...
  notification_template_master: {
    ...
    fields: [
      ...
      { name: "content_mode", type: "select", label: i18nLabel("Icerik Modu", "Content Mode"), required: true, options: [option("freeform","Serbest Metin","Freeform"), option("template","Saglayici Sablonu","Provider Template")] },
      { name: "provider_template_name", type: "text", label: i18nLabel("Saglayici Sablon Adi", "Provider Template Name"), fullWidth: true },
      { name: "provider_template_category", type: "text", label: i18nLabel("Saglayici Kategori", "Provider Category") },
      { name: "variables_schema_json", type: "textarea", label: i18nLabel("Degisken Semasi JSON", "Variables Schema JSON"), rows: 3, fullWidth: true },
      { name: "subject", type: "text", label: i18nLabel("Konu", "Subject"), fullWidth: true },
      { name: "body_template", type: "textarea", label: i18nLabel("Sablon Govdesi", "Body Template"), required: true, rows: 5, fullWidth: true },
      { name: "sms_body_template", type: "textarea", label: i18nLabel("SMS Govdesi", "SMS Body"), rows: 3, fullWidth: true },
      { name: "email_body_template", type: "textarea", label: i18nLabel("E-posta Govdesi", "Email Body"), rows: 3, fullWidth: true },
      { name: "whatsapp_body_template", type: "textarea", label: i18nLabel("WhatsApp Govdesi", "WhatsApp Body"), rows: 3, fullWidth: true },
  ...
  ownership_assignment: {
    ...
    title: i18nLabel("Hizli Atama", "Quick Assignment"),
    subtitle: i18nLabel("Kayit sahipligi ve operasyon atamasi olustur", "Create a record ownership and operational assignment"),
    ...
    fields: [
      ...
      { name: "source_name", type: "text", label: i18nLabel("Kaynak Kayit", "Source Record"), required: true },
      { name: "customer", type: "select", label: i18nLabel("Musteri", "Customer"), optionsSource: "customers" },
      { name: "policy", type: "select", label: i18nLabel("Police", "Policy"), optionsSource: "policies" },
...
addQuickEditVariant(
  ...
  "Musteri Iliskisini Duzenle",
  "Edit Customer Relation",
  "Iliski alanlarini guncelle",
  "Update relation fields"
);
addQuickEditVariant(
  "insured_asset",
  "insured_asset_edit",
  "Sigortalanan Varligi Duzenle",
  "Edit Insured Asset",
  "Varlik alanlarini guncelle",
...
addQuickEditVariant(
  "call_note",
  "call_note_edit",
  "Arama Notunu Duzenle",
  "Edit Call Note",
  "Arama notu alanlarini guncelle",
