export const IMPORT_TRANSLATIONS = {
  tr: {
    ...
    previewEmptyHint: "Dosya yükleyip kolon eşleştirmesini tamamladıktan sonra önizleme burada görünür.",
    ...
    jobHistoryEmpty: "Henüz içe aktarma işi bulunmuyor.",
    jobHistoryEmptyHint: "Tamamlanan veya devam eden işler burada listelenir.",
    jobIdLabel: "İş No",
    ...
    requiredFieldsLabel: "Zorunlu Alanlar",
    duplicateMappingLabel: "Aynı hedef alana birden fazla kolon eşlendi",
    duplicateMappingHint: "Şu alanlar birden fazla kolona eşlendi: {fields}. Bu, öngörülemeyen verilere yol açabilir.",
    retry: "Tekrar Dene",
    dismiss: "Kapat",
  },
  en: {
    ...
    previewEmptyHint: "Upload a file and complete column mapping to see the preview here.",
    ...
    jobHistoryEmpty: "No import jobs yet.",
    jobHistoryEmptyHint: "Completed and in-progress jobs will appear here.",
    jobIdLabel: "Job ID",
    ...
    duplicateMappingLabel: "Multiple columns map to the same target field",
    duplicateMappingHint: "These fields are mapped from more than one column: {fields}. This may lead to unexpected data.",
    retry: "Retry",
    dismiss: "Dismiss",
  },
};
