export const AUX_DETAIL_TRANSLATIONS = {
  tr: {
    ...
    relatedLinkedCustomer: "İlişkili Müşteri",
    ...
    relationContext: "İlişki Bağlamı",
    relationLifecycle: "İlişki Yaşam Döngüsü",
    relationNotes: "İlişki Notları",
    assetContext: "Varlık Bağlamı",
    assetLifecycle: "Varlık Yaşam Döngüsü",
    assetNotes: "Varlık Notları",
    ...
    fileInfo: "Dosya",
    fileContext: "Dosya Bağlamı",
    fileMeta: "Dosya Detayları",
    ...
    valSibling: "Kardeş",
    valPartner: "Partner",
    valHousehold: "Hane Halkı",
    valVehicle: "Araç",
    valHome: "Konut",
    valHealthPerson: "Sağlık Kişisi",
    valWorkplace: "İş Yeri",
    valTravel: "Seyahat",
    valBoat: "Tekne",
    valFarm: "Çiftlik",
    ...
    valDelete: "Sil",
    valRun: "Çalıştır",
    valExport: "Dışa Aktar",
    valMedium: "Orta",
    valStandard: "Standart",
    valMidValue: "Orta Değer",
    valHighValue: "Yüksek Değer",
  },
  en: {
    ...
    relatedLinkedCustomer: "Related Customer",
    ...
    relationLifecycle: "Relation Lifecycle",
    ...
    valSibling: "Sibling",
    valPartner: "Partner",
    valHousehold: "Household",
    valVehicle: "Vehicle",
    valHome: "Home",
    valHealthPerson: "Health Person",
    valWorkplace: "Workplace",
    valTravel: "Travel",
    valBoat: "Boat",
    valFarm: "Farm",
