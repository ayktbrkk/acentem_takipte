export const AUX_WORKBENCH_FIELD_LABELS = {
  tr: {
    ...
    "office-branches": {
      office_branch_name: "Ofis Şube Adı",
      office_branch_code: "Ofis Şube Kodu",
      is_head_office: "Genel Müdürlük",
      city: "Şehir",
      parent_office_branch: "Üst Ofis Şubesi",
      manager_user: "Yönetici",
      is_active: "Aktif",
      modified: "Güncellendi",
      owner: "Kayıt Sahibi",
    },
    "sales-entities": {
      ...
      is_root: "Kök",
      commission_share_pct: "Komisyon Payı %",
      owner: "Kayıt Sahibi",
      modified: "Güncellendi",
    },
    templates: {
  ...
  en: {
    ...
    "office-branches": {
      office_branch_name: "Office Branch Name",
      office_branch_code: "Office Branch Code",
      is_head_office: "Head Office",
      city: "City",
      parent_office_branch: "Parent Office Branch",
    ...
    "sales-entities": {
      ...
      is_root: "Root",
      commission_share_pct: "Commission Share %",
      owner: "Owner",
      modified: "Modified",
    },
    templates: {
