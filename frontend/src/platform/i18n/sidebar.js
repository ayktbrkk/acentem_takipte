...
export const SIDEBAR_TRANSLATIONS = {
  tr: {
    ...
    dismiss: "Kapat",
    refresh: "Yenile",
    scopeRefreshNotice: "Erişim yetkileriniz güncellendi. Güncel yetkilerle devam etmek için sayfayı yenileyin.",
    emergencyAccessNotice: "DİKKAT: {beneficiary} kullanıcısına {scope} için acil erişim yetkisi verildi.",
    defaultPage: "Pano",
  ...
  en: {
    ...
    dismiss: "Dismiss",
    refresh: "Refresh",
    scopeRefreshNotice: "Your access permissions have been updated. Refresh to continue with the latest permissions.",
    emergencyAccessNotice: "NOTICE: Emergency access granted to {beneficiary} for {scope}.",
