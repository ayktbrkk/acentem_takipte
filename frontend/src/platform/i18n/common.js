export const COMMON_TRANSLATIONS = {
  tr: {
    ...
    divorced: "Boşanmış",
    enter_national_id_help: "11 haneli T.C. kimlik numarası giriniz.",
    enter_tax_id_help: "10 haneli vergi numarası giriniz.",
    female: "Kadın",
    ...
    requestSubmitFailed: "Talep gönderilemedi. Lütfen tekrar deneyin.",
    requestSubmitError: "Talep gönderilirken hata oluştu: {message}",
    searchFailed: "Müşteri araması tamamlanamadı. Lütfen tekrar deneyin.",
    searchError: "Müşteri aranırken hata oluştu: {message}",
    ...
    reject_reason_prompt: "Ret sebebini girin",
    new_offer: "Yeni Teklif",
    sort_modified_desc: "Son Güncellenen",
    sort_valid_until_asc: "Geçerlilik (Artan)",
    sort_valid_until_desc: "Geçerlilik (Azalan)",
    sort_gross_desc: "Prime Göre",
    preset_default: "Tümü",
    offerDetailTitle: "Teklif Detayı",
    days: "gün",
    preview: "Önizleme",
    ...
    rowStatusReady: "Hazır",
    rowStatusSkipped: "Atlandı",
    rowStatusError: "Hata",
  ...
  en: {
    ...
    requestSubmitFailed: "Failed to submit the request. Please try again.",
    requestSubmitError: "Error submitting request: {message}",
    searchFailed: "Customer search could not be completed. Please try again.",
    searchError: "Error searching customer: {message}",
    ...
    sort_valid_until_asc: "Validity (Ascending)",
    sort_valid_until_desc: "Validity (Descending)",
    sort_gross_desc: "By Premium",
    preset_default: "All",
