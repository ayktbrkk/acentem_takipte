...
def build_lead_workbench_base_kwargs(*, query_filters: dict, or_filters, order_by: str) -> dict:
    kwargs = {
        "doctype": "AT Lead",
...
def build_lead_workbench_derived_sort_seed_kwargs(*, query_filters: dict, or_filters) -> dict:
    kwargs = {
        "doctype": "AT Lead",
...
def fetch_lead_workbench_rows(*, base_kwargs: dict, limit_start: int, limit_page_length: int) -> list[dict]:
