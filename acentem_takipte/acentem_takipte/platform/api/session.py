...
SESSION_CAPABILITY_QUICK_CREATE: dict[str, str] = {
    ...
    "office_branch_master": "AT Office Branch",
...
SESSION_CAPABILITY_QUICK_EDIT: dict[str, str] = {
    ...
    "office_branch_master_edit": "AT Office Branch",
...
SPA_HOME_ROLES = {"AT Manager", "AT Agent", "AT Accountant", "AT System Manager", "AT User", "AT Customer"}
