...
from acentem_takipte.acentem_takipte.domains.admin.services import jobs as admin_jobs
from acentem_takipte.acentem_takipte.domains.customers.services import customer_segments
