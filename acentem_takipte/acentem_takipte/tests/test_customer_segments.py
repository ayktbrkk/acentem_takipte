...
from acentem_takipte.acentem_takipte.domains.admin.services.jobs import admin_jobs
from acentem_takipte.acentem_takipte.domains.customers.services.customer_segments import customer_segments
