...
from acentem_takipte.acentem_takipte.domains.reports.services import registry as report_registry
from acentem_takipte.acentem_takipte.domains.reports.services import snapshots as report_snapshots
