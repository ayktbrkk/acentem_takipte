...
def test_assert_mutation_access_runs_common_security_contract():
    with patch("acentem_takipte.acentem_takipte.platform.utils.permissions.assert_authenticated", return_value="manager@example.com") as assert_authenticated_mock:
        with patch("acentem_takipte.acentem_takipte.platform.utils.permissions.assert_post_request") as assert_post_request_mock:
            with patch("acentem_takipte.acentem_takipte.platform.utils.permissions.assert_roles") as assert_roles_mock:
                with patch("acentem_takipte.acentem_takipte.platform.utils.permissions.assert_doctype_permission") as assert_doctype_permission_mock:
                    with patch("acentem_takipte.acentem_takipte.platform.utils.permissions.audit_admin_action") as audit_mock:
