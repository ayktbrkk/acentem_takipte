...
SCREEN_EXPORTS: dict[str, dict[str, Any]] = {
    "lead_list": {
        ...
        "columns": [
            ...
            _column("modified", _t("Güncellendi", "Modified"), formatter="datetime"),
        ],
    },
    "customer_list": {
        "permission_doctype": "AT Customer",
        "export_key": "customer_list",
        "title": _t("Müşteri Listesi", "Customer List"),
        "type": "custom",
        "fetcher": "_fetch_customer_rows",
        "columns": [
            _column("full_name", _t("Müşteri", "Customer"), getter=lambda row: row.get("full_name") or row.get("name")),
            _column("name", _t("Kayıt", "Record")),
            ...
            _column("active_policy_count", _t("Aktif Poliçe", "Active Policies")),
            _column("open_offer_count", _t("Açık Teklif", "Open Offers")),
            _column("active_policy_gross_premium", _t("Aktif Brüt Prim", "Active Gross Premium"), formatter="currency"),
            _column("modified", _t("Güncellendi", "Modified"), formatter="datetime"),
        ],
    },
    "policy_list": {
        ...
        "title": _t("Poliçe Listesi", "Policy List"),
        "type": "doctype",
        "doctype": "AT Policy",
        "fields": [
            "name",
        ...
        "columns": [
            ...
            _column("insurance_company", _t("Sigorta Şirketi", "Insurance Company")),
            _column("status", _t("Durum", "Status")),
            _column("end_date", _t("Bitiş Tarihi", "End Date"), formatter="date"),
            _column("gross_premium", _t("Brüt Prim", "Gross Premium"), formatter="currency", currency_field="currency"),
            _column(
                "commission_display",
    ...
    "offer_list": {
        ...
        "columns": [
            ...
            _column("valid_until", _t("Geçerlilik", "Valid Until"), formatter="date"),
            _column("gross_premium", _t("Brüt Prim", "Gross Premium"), formatter="currency", currency_field="currency"),
