...
## 2. Ana Dizin Haritası

### 2.1 Root'ta bırakılan canlı / zorunlu dosyalar

| Yol | Durum | Neden burada kaldı |
|---|---|---|
| `.gitattributes` | Kaldı | Git davranışı için |
| `.gitignore` | Kaldı | Üretim dışı dosya filtresi |
| `.github/` | Kaldı | CI / repo otomasyonu |
| `LICENSE` | Kaldı | Lisans metni |
| `MANIFEST.in` | Kaldı | Python paket içeriği |
| `pyproject.toml` | Kaldı | Paket sürüm / build metadata |
| `requirements.txt` | Kaldı | Python bağımlılıkları |
| `setup.py` | Kaldı | Python paket kurulumu |
| `README.md` | Kaldı | Repo giriş dokümanı |
| `DOSYA_REFACTOR_REHBERI.md` | Kaldı | Gelecek agent'lar için çalışma rehberi |
| `DOSYA_HARITASI_RAPORU.md` | Kaldı | Bu harita ve arşiv raporu |
| `acentem_takipte/` | Kaldı | Frappe Python uygulaması |
| `frontend/` | Kaldı | Vue SPA kaynakları |
| `docs/` | Kaldı | Root klasörü boş bırakıldı; içerik olarak kullanılan plan/spec dosyaları arşive taşındı |
| `silinecekler/` | Kaldı | Arşiv alanı |

### 2.2 Bu temizlikte arşive taşınan root destek dosyaları

| Kaynak | Arşiv yolu | Neden taşındı |
|---|---|---|
| `API_VERSIONING.md` | `silinecekler/docs/API_VERSIONING.md` | Canlı uygulama için gerekli değildi; API evrimi notu |
| `BUYUK_EKRAN_REFACTOR_TAKIP.md` | `silinecekler/docs/BUYUK_EKRAN_REFACTOR_TAKIP.md` | Refactor çalışma takibi; runtime için zorunlu değil |
| `DASHBOARD_REFACTOR_NOTES.md` | `silinecekler/docs/DASHBOARD_REFACTOR_NOTES.md` | Geçici refactor notu |
| `REPORTS_REFACTOR_NOTES.md` | `silinecekler/docs/REPORTS_REFACTOR_NOTES.md` | Geçici refactor notu |
| `TEKNIK_DENETIM_TAKIP.md` | `silinecekler/docs/TEKNIK_DENETIM_TAKIP.md` | Denetim takibi; canlı çalışma için zorunlu değil |
| `docs/superpowers/plans/*.md` | `silinecekler/docs/superpowers/plans/` | Agent plan artefact'ları |
| `docs/superpowers/specs/*.md` | `silinecekler/docs/superpowers/specs/` | Agent spec artefact'ları |
| `frontend/scripts/e2e/*.mjs` | `silinecekler/frontend/scripts/e2e/` | Yardımcı doğrulama script'leri; canlı app çalışması için zorunlu değil |

---

## 3. Canlı Uygulamanın Mimari Akışı
